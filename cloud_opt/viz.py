...
from .utils.geometry import geotrf, get_med_dist_between_poses, depthmap_to_absolute_camera_coordinates
...
class SceneViz:
    ...
    def show(self, point_size=2):
        ...
        self.scene.export(glb_filename)
        print(f"场景数据已保存到文件: {glb_filename}")
